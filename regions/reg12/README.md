...
This folder is the region-default content layer for `reg12`.
...
- `regions/reg12/data/primary-assets.json`
- `regions/reg12/data/primary.json`
- `regions/reg12/data/footer.json`
- `regions/reg12/data/primaryending.json`
- `regions/reg12/assets/primary/manifest.json`
- `regions/reg12/assets/footer/manifest.json`
...
Use this folder for region-wide defaults that should affect `reg12`.
